    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            ...
            <div class="space-y-16">
                ...
                <div class="experience-card opacity-0" data-direction="left" data-delay="0" data-mobile-delay="0">
                ...
                <div class="experience-card opacity-0" data-direction="right" data-delay="300" data-mobile-delay="150">
                    <div class="flex flex-col md:flex-row items-center">
                        <div class="hidden md:block md:w-1/2"></div>
                        <div class="hidden md:block relative">
                            <div
                ...
                <div class="experience-card opacity-0" data-direction="left" data-delay="600" data-mobile-delay="300">
                    <div class="flex flex-col md:flex-row items-center">
                        <div class="w-full md:w-1/2 md:pr-8 text-left md:text-right">
                            <div
                                class="glass rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                ...
                {{-- Youth Chairman --}}
                <div class="experience-card opacity-0" data-direction="right" data-delay="900" data-mobile-delay="450">
                    <div class="flex flex-col md:flex-row items-center">
                        <div class="hidden md:block md:w-1/2"></div>
                        <div class="hidden md:block relative">
                            <div
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function animateCards() {
            ...
            experienceCards.forEach((card, index) => {
                ...
                const delay = parseInt(isMobile ? card.dataset.mobileDelay : card.dataset.delay) || 0;

                const timeout = setTimeout(() => {
                    card.style.opacity = '1';
                    if (isMobile) {
                        card.classList.add('animate-slideInFromUpMobile');
                    } else {
                        if (direction === 'left') {
