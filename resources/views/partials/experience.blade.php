...
<section id="experience" class="py-20 bg-transparent relative overflow-hidden">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            {{-- Timeline line --}}
            <div
                class="absolute left-1/2 transform -translate-x-0.5 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 opacity-30 rounded-full">
            </div>
                            ...
                            <div
                                ...
                                <ul class="text-gray-300 space-y-2">
                                    <li class="flex items-start justify-end">
                                        <span class="text-right flex-1 mr-3">Develop Point of Sale (POS) systems for
                                            retail businesses</span>
                                        <span class="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></span>
                                    </li>
                                    <li class="flex items-start justify-end">
                                        <span class="text-right flex-1 mr-3">Create custom applications tailored to
                                            client needs</span>
                                        <span class="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></span>
                                    </li>
                                    <li class="flex items-start justify-end">
                                        <span class="text-right flex-1 mr-3">Maintain long-term client relationships and
                                            system updates</span>
                                        <span class="w-2 h-2 bg-pink-400 rounded-full mt-2 flex-shrink-0"></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 md:pr-8 text-left md:text-right">
                            <div
                                ...
                                <ul class="text-gray-300 space-y-2">
                                    <li class="flex items-start justify-end">
                                        <span class="text-right flex-1 mr-3">Technical support for students and
                                            staff</span>
                                        <span class="w-2 h-2 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></span>
                                    </li>
                                    <li class="flex items-start justify-end">
                                        <span class="text-right flex-1 mr-3">Hardware troubleshooting and repair</span>
                                        <span class="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></span>
                                    </li>
                                    <li class="flex items-start justify-end">
                                        <span class="text-right flex-1 mr-3">Network infrastructure maintenance</span>
                                        <span class="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></span>
                                    </li>
                                </ul>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Reset animation when scrolling away (optional)
        ...
        window.addEventListener('scroll', () => {
            ...
            // If we've scrolled completely past the section, reset for next time
